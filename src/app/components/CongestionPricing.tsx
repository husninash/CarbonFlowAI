  ...
  return (
    <div className="bg-[#0f0f14] border border-[#1a1a24] rounded-xl p-6">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-lg font-bold text-white">Dynamic Pricing</h3>
          <p className="text-sm text-gray-400">Real-time congestion toll rates</p>
        </div>
      </div>

      <div className="bg-gradient-to-r from-[#00ff88]/10 to-[#00d9ff]/10 border border-[#00ff88]/20 rounded-lg p-4 mb-6">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-xs text-gray-400 mb-1">Current Multiplier</div>
            <div className="text-2xl font-bold text-white">1.5x</div>
          </div>
          <div className="text-right">
            <div className="text-xs text-gray-400 mb-1">Peak Hours Active</div>
      ...
      <div className="space-y-3">
        {pricingTiers.map((tier, index) => {
          ...
          return (
            <div key={index} className="bg-[#0a0a0f] rounded-lg p-4 border border-[#1a1a24] hover:border-[#00ff88]/30 transition-all">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-white">{tier.category}</div>
      ...
      <div className="mt-6 pt-4 border-t border-[#1a1a24]">
        <div className="grid grid-cols-3 gap-3">
          <div className="text-center">
            <div className="text-xs text-gray-400 mb-1">Revenue Today</div>
            <div className="text-sm font-bold text-[#00ff88]">$34,580</div>
          </div>
          <div className="text-center">
            <div className="text-xs text-gray-400 mb-1">Green Vehicles</div>
            <div className="text-sm font-bold text-[#00d9ff]">23.4%</div>
          </div>
          <div className="text-center">
            <div className="text-xs text-gray-400 mb-1">Saved Carbon</div>
